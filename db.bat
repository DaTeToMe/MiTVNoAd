...
for %%a in (
    ...
    "com.xiaomi.devicereport"           REM 设备报告
    ...
    "com.xiaomi.tv.gallery"             REM 时尚画报
    ...
    "com.xiaomi.smarthome.tv.service"             REM 米家服务
    REM ""             REM 无说明未测试
    REM ""             REM 无说明未测试
    REM ""             REM 无说明未测试
) do (
